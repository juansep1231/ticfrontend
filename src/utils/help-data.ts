export const glosaryBank = [
  {
    word: 'Transacción',
    meaning:
      'Una transacción es cualquier intercambio económico que se realiza entre dos o más partes. En el contexto de sistemas informáticos, puede referirse a una serie de operaciones que deben completarse exitosamente para mantener la integridad de los datos.',
  },
  {
    word: 'Bienes muebles',
    meaning:
      'Los bienes muebles son aquellos que pueden trasladarse de un lugar a otro sin que ello afecte su integridad física. Ejemplos incluyen vehículos, maquinaria y equipos.',
  },
  {
    word: 'Bienes inmuebles',
    meaning:
      'Los bienes inmuebles son propiedades que no pueden moverse sin alterar su naturaleza, como terrenos y edificaciones. Son también conocidos como bienes raíces.',
  },
  {
    word: 'Activos',
    meaning:
      'Los activos son recursos que poseen valor económico y que son propiedad de una empresa o individuo. Incluyen efectivo, cuentas por cobrar, inventarios, propiedades y equipo.',
  },
  {
    word: 'Pasivos',
    meaning:
      'Los pasivos son obligaciones financieras que una empresa o individuo debe a otros. Ejemplos incluyen préstamos, cuentas por pagar y otras deudas pendientes.',
  },
];
